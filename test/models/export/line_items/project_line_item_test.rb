...
class ProjectLineItemTest < ModelTestCase
  ...
  test 'csv' do
    timesheet = Timesheet.create
    project = Project.create client: 'Mickey', name: 'Mouse', code: 'SOW111'
    ...
    Activity.create(timesheet_id: timesheet.id,
                    ...
                    start_time: monday.at(4, 15),
                    end_time: monday.at(5, 15))
    Activity.create(timesheet_id: timesheet.id,
                    story_card_id: card1.id,
                    start_time: tuesday.at(4, 15),
                    end_time: tuesday.at(5, 15))
